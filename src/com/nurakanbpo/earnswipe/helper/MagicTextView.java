	...
	public void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray a = getContext().obtainStyledAttributes(attrs,
					R.styleable.MagicTextView);

			String typefaceName = a
					.getString(R.styleable.MagicTextView_typeface);
			...
			if (a.hasValue(R.styleable.MagicTextView_foreground)) {
				...
				if (foreground != null) {
					...
					this.setTextColor(a.getColor(
							R.styleable.MagicTextView_foreground, 0xff000000));
				}
			}

			if (a.hasValue(R.styleable.MagicTextView_background)) {
				Drawable background = a
						.getDrawable(R.styleable.MagicTextView_background);
				if (background != null) {
					this.setBackgroundDrawable(background);
				} else {
					this.setBackgroundColor(a.getColor(
							R.styleable.MagicTextView_background, 0xff000000));
				}
			}
